    ...
    const InputCalendar = forwardRef((props, ref) => {
        ...
        return (
            <div className="c-input c-input-calendar" tabIndex={0} onFocus={open} onBlur={close}>
                {
                    props.label ? <label className="c-input__label u-text--light" htmlFor={props.id}>{props.label}</label> : ''
                }
                <div className="c-input__cont-input ">
                    ...
                    <Icon className="c-input__icon left u-text--blue" h="24">calendar_today</Icon>
                </div>
                {
