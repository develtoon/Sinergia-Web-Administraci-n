        ...
        const handleChange = (e) => {
            ...
            if (name === "texto") {
                ...
                if (name === "idTipoBien") {
                    ...
                    if (value === "") {
                        setDataFilter({ ...dataFilter, idSubTipoBien: '' })
                    }
                }
                                                            ...
                                                            <tr key={item.id}>
                                                                <td className="c-table__options text-centers">
                                                                    <Dropdown drop="up">
                                                                        ...
                                                                        <Dropdown.Menu>
                                                                            <Dropdown.Item href={`${smart.urlContext}/Edit/${item.id}`} eventKey="1">{appContext.permisos.esUsuarioEditar ? 'Editar' : 'Ver'}</Dropdown.Item>
                                                                            {appContext.permisos.esUsuarioEliminar && <Dropdown.Item onClick={(ev) => handleDelete(ev, item.id)} eventKey="2">Eliminar</Dropdown.Item>}
                                                                        </Dropdown.Menu>
                                                                    </Dropdown>
                                                                </td>
                                                                <td className="text-center u-text--regular u-text--bold" style={{ width: "80px" }}><a className="c-link" href={`${smart.urlContext}/Edit/${item.id}`}>{item.codigo}</a></td>
