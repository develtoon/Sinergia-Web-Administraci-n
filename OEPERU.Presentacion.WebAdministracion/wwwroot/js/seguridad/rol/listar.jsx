        ...
        useEffect(() => {
            ...
            axios.all([menuPermiso]).
                then(response => {
                    ...
                    let listarEstado = catalogoEstadoBuscar(10301)
                        ...
                        <table className="c-table__container--content mb-2">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">
                                        <div className="text-left flex align-center" onClick={() => { setOrderDir('tiporol') }}>
                                            Tipo
                                            {getOrderDir('tiporol')}
                                        </div>
                                    </th>
                                            ...
                                            data.map((item) => {
                                                return (
                                                    <tr key={item.id}>
                                                        ...
                                                        <td className="text-center u-text--bold" style={{ width: "50px" }}>{item.codigo}</td>
                                                        <td className="text-left u-text--regular">{item.nombre}</td>
                                                        <td className="text-left">{item.tiporol}</td>
